 ...
 * Do not redistribute
 *
 * @title tktr90755.display.ticker.ExRenderer.ts
 * @author
 * @version 0.1.0
 * @update
 */
import ITicker from "./ITicker";
export default class ExRenderer implements ITicker {
  private static _instance: ExRenderer;
  ...
  public static get instance(): ExRenderer {
    if (!this._instance) this._instance = new ExRenderer();
